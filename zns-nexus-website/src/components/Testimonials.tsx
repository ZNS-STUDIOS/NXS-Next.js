...
export const Testimonials = () => {
    ...
    return (
        <section className="py-32 bg-zns-cream relative overflow-hidden">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="mb-12 flex justify-center">
                        <Quote className="w-16 h-16 text-zns-blue opacity-20" />
                    </div>
                    ...
                    <div className="h-[300px] md:h-[250px] relative flex items-center justify-center">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <p className="text-2xl md:text-4xl font-display font-medium text-zns-dark leading-relaxed mb-8">
                                    &ldquo;{testimonials[current].content}&rdquo;
                                </p>
                                <div>
                                    <h4 className="text-xl font-bold text-zns-dark">{testimonials[current].name}</h4>
                                    <p className="text-zns-blue font-medium">{testimonials[current].role}</p>
                                </div>
                            </motion.div>
                        </AnimatePresence>
                    </div>
                    ...
                    <div className="flex justify-center gap-4 mt-12">
                        <button
                            onClick={prev}
                            className="p-4 rounded-full border border-zns-dark/10 text-zns-dark hover:bg-zns-dark hover:text-white transition-all duration-300 group shadow-lg shadow-black/5"
                        >
